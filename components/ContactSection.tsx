        ...
        <div className="bg-pink-50 rounded-3xl p-8 sm:p-12 border-2 border-yellow-200 shadow-lg">
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-pink-100 hover:border-green-300 hover:shadow-md transition-all duration-200 cursor-pointer group"
            >
            ...
            <a
              href="https://instagram.com/chayalea_events"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-pink-100 hover:border-pink-300 hover:shadow-md transition-all duration-200 cursor-pointer group"
            >
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-100 to-purple-100 flex items-center justify-center flex-shrink-0 group-hover:from-pink-200 group-hover:to-purple-200 transition-all">
                <svg
                  className="w-5 h-5 text-pink-600"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <div className="text-left">
                ...
                {/* Replace with Chaya Lea's real Instagram */}
                <p
                  className="text-pink-900 text-lg font-medium"
                  style={{ fontFamily: "var(--font-cormorant)" }}
                >
